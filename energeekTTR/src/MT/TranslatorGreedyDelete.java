 ...
 */
public class TranslatorGreedyDelete {
...
public void Rank(int dataid,ArrayList<PrintWriter> outputlist,ArrayList<String> deletestring) throws NumberFormatException, IOException{
	...
	public void Curve() throws IOException{
		String filename = "F:/ACL/NLP/IDRANK/TERStandardTranslatorIDrank.txt";
		BufferedReader in = new BufferedReader(new FileReader(filename));
		String ss = "";
		boolean bscan; 
		...
		String writefile = "F:/ACL/NLP/Evaluate/PlainText/CURVE/ontranslatorrank.txt";
