...
//	}
	...
	public static void init(boolean tokenizeWithSpace) {
		...
		props.put("parser.model", FileManager.getResource("resources/model/englishPCFG.ser.gz"));
