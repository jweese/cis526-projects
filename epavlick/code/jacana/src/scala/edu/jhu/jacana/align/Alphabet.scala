...
object IndexLabelAlphabet {
    ...
    def main(args: Array[String]): Unit = {
        ...
        var tgtLen = 10
        println(getMaxMergedStateIdx(tgtLen))
        println
        
        var idx = getMergedStateIdx(2, tgtLen, 2)
        println(idx)
        println(getPosAndSpanByStateIdx(idx, tgtLen))
        println
        
        idx = getMergedStateIdx(2, tgtLen, 3)
        println(idx)
        println(getPosAndSpanByStateIdx(idx, tgtLen))
        println
        
        idx = getMergedStateIdx(8, tgtLen, 2)
        println(idx)
        println(getPosAndSpanByStateIdx(idx, tgtLen))
        println
        
        idx = getMergedStateIdx(8, tgtLen, 3)
        println(idx)
        println(getPosAndSpanByStateIdx(idx, tgtLen))
        println
        
        idx = getMergedStateIdx(9, tgtLen, 2)
        println(idx)
        println(getPosAndSpanByStateIdx(idx, tgtLen))
        println
