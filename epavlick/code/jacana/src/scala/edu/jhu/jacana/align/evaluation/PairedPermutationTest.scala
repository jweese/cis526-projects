...
object PairedPermutationTest {
    ...
    def main(args: Array[String]): Unit = {
		...
		val goldData = new AlignTrainData("alignment-data/msr/converted/RTE2_test_M.align.txt")
		val t1 = new AlignTrainData("/tmp/RTE2_test_M.align.txt.t2s", true)
		val t2 = new AlignTrainData("/tmp/RTE2_test_M.align.txt.union")
		test(goldData, t1, t2)
    }
