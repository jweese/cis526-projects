...
java -mx4g -DJACANA_HOME=../ -jar ../build/lib/jacana-align.jar -m $1 -a $data_dir/$testfile/$testfile.json -o $testfile.es-en.json --reverse --default
...
java -mx4g -DJACANA_HOME=../ -jar ../build/lib/jacana-align.jar -m $2 -a $data_dir/$testfile/$testfile.json -o $testfile.en-es.json --default
